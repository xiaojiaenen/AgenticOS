...
# wuwei 2.1.4 bug: Context.add_ai_message(tool_calls=None) 传 None 给
# Message(tool_calls=None)，但 BaseMessage.tool_calls: list[ToolCall]
# 拒绝 None。Monkey-patch 自动将 None 转为 []。
