...
class AgentProfileBase(BaseModel):
    ...
    response_mode: str = Field(default="general", pattern="^(general|ppt|website|video|email|bigdata)$")
...
class AgentProfileUpdateRequest(BaseModel):
    ...
    response_mode: str | None = Field(default=None, pattern="^(general|ppt|website|video|email|bigdata)$")
    avatar: str | None = Field(default=None, max_length=64)
