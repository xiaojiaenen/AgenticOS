    ...
    {isLoading ? (
     ...
     profiles.map((profile, index) => (
      ...
      >
       ...
       <div className="text-sm font-medium text-slate-600">{formatApiDate(profile.updated_at)}</div>
     ...
     >
      ...
      >
       ...
       <div className="grid flex-1 grid-cols-1 overflow-hidden xl:grid-cols-[minmax(0,1.05fr)_420px]">
         ...
         <div className="grid grid-cols-1 gap-3.5 lg:grid-cols-2">
          ...
          <label className="space-y-1.5">
           ...
           <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-800 outline-none transition disabled:opacity-60 focus:border-sky-200 focus:bg-white focus:ring-4 focus:ring-sky-100/80"
           />
          </label>
          ...
          <label className="space-y-1.5">
           <span className="text-xs font-semibold tracking-[0.08em] text-slate-400">响应模式</span>
           <select
          ...
          <label className="space-y-1.5">
           <span className="text-xs font-semibold tracking-[0.08em] text-slate-400">最大步数</span>
           <input
            type="number"
            min={1}
            max={2147483647}
          ...
          <div className="space-y-3 lg:col-span-2">
           <div className="flex flex-wrap items-center justify-between gap-3">
            <span className="text-xs font-semibold tracking-[0.08em] text-slate-400">启用范围</span>
          ...
          <label className="space-y-2 lg:col-span-2">
           <span className="text-xs font-semibold tracking-[0.08em] text-slate-400">系统提示词</span>
           <textarea
        ...
        <div className="overflow-y-auto border-l border-slate-100 bg-white/80 p-5">
         <div className="space-y-4">
          {/* 右侧面板 Tab 切换 */}
          <div className="sticky top-0 z-10 -mx-5 -mt-5 bg-white/80 px-5 pt-5 pb-3 ">
             ...
             return (
              <div key={tool.tool_name} className="rounded-lg border border-slate-200 bg-white p-3.5">
               ...
               <div className="mt-4 flex items-center gap-3">
                <div className="flex items-center justify-between rounded-xl border border-slate-200 bg-white px-3.5 py-2.5 flex-1">
                 <span className="text-sm font-semibold text-slate-700">启用</span>
                ...
                {hasSubTools ? (
                 <button
                  ...
                  className={cn(
                   'flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3.5 py-2.5 text-sm font-semibold transition-colors hover:bg-sky-50',
                  ...
                  return (
                   <div
                    ...
                    className={cn(
                     ...
                     isApproved ? 'border-amber-200/80 bg-amber-50/60' : 'border-slate-200/80 bg-white/80',
                    )}
                   >
                    <div className="min-w-0">
                     <p className="text-xs font-medium text-slate-800">{sub.label}</p>
